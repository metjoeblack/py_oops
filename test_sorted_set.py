...
from collections.abc import Container, Sequence, Iterable, Sized
...
class TestReprProtocol(unittest.TestCase):
    ...
    def test_repr_one(self):
        s = SortedSet([42, 47, 19])
        self.assertTrue(repr(s), "SortedSet([19, 42, 47])")


class TestEqualityProtocol(unittest.TestCase):
    
    def test_positive_equal(self):
        self.assertTrue(SortedSet([4, 5, 6]) == SortedSet([5, 6, 4]))

    def test_negative_equal(self):
        self.assertFalse(SortedSet([4, 5, 6]) == SortedSet([1, 5, 4]))
...
class TestInequalityProtocol(unittest.TestCase):
    ...
    def test_positive_unequal(self):
        self.assertTrue(SortedSet([4, 5, 6]) != SortedSet([2, 3, 1]))

    def test_negative_unequal(self):
        self.assertFalse(SortedSet([4, 5, 6]) != SortedSet([6, 4, 5]))
...
class TestRationalSetProtocol(unittest.TestCase):

    def setUp(self) -> None:
        self.s = SortedSet({1, 2})
        self.m = SortedSet({1, 2, 3})
        self.l = SortedSet({1, 2, 3})
    
    def test_lt_positive(self):
        self.assertTrue(self.s < self.m)

    def test_lt_negative(self):
        self.assertFalse(self.m < self.l)

    def test_le_lt_positive(self):
        self.assertTrue(self.s <= self.m)

    def test_le_eq_positive(self):
        self.assertTrue(self.m <= self.l)

    def test_le_negative(self):
        self.assertFalse(self.m <= self.s)

    def test_gt_positive(self):
        self.assertTrue(self.m > self.s)
